...
client.connect_signal("manage", function(c)
    ...
    -- Give ST and icon
    if c.class == "kitty" or c.class == "kitty-dialog" or c.class ==
        "kitty-float" or c.instance == "kitty-256color" or c.instance == "kitty" then
        local new_icon = gears.surface(gfs.get_configuration_dir() ..
                                           "icons/ghosts/kitty.svg")
        awful.spawn.easy_async_with_shell("sleep 0.04", function()
