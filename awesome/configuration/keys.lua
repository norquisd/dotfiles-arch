...
awful.keyboard.append_global_keybindings(
    {
        ...
        awful.key({modkey}, "b",
                  function() awful.spawn(browser, {maximized = false}) end,
                  {description = "open a browser", group = "launcher"}),
        awful.key({modkey}, "t",
                  function() awful.spawn(terminal .. " -e ranger") end,
        ...
        awful.key({modkey}, "space", function()
            awful.spawn.with_shell("~/.config/rofi/launchers/misc/launcher.sh")
        ...
        awful.key({}, "XF86AudioRaiseVolume",
                  function()
                      awful.spawn.with_shell("amixer -D pulse sset Master 5%+ > /dev/null")
        ...
        awful.key({}, "XF86AudioMute",
                  function()
                      awful.spawn.with_shell("pactl -- set-sink-mute @DEFAULT_SINK@ toggle > /dev/null")
                  end,
                  {description = "mute volume", group = "screen"})
    })
