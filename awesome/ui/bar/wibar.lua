...
-- Awesome Panel -----------------------------------------------------------
local image_uncolored = gears.surface.load_uncached(gfs.get_configuration_dir() ..
                                        "icons/ghosts/awesome.png")

local icon1 = wibox.widget {
    widget = wibox.widget.imagebox,
    resize = true,
    image = gears.color.recolor_image(image_uncolored, beautiful.xbackground)
...
awesome.connect_signal("signal::battery", function(value)
    ...
    if value >= 90 then
        battery_icon.markup = "<span foreground='" .. beautiful.xcolor2 .. "'>" ..
                                  bat_icon .. "</span>"
    elseif value <15 then
        battery_icon.markup = "<span foreground='" .. beautiful.xcolor1 .. "'>" ..
                                  bat_icon .. "</span>"
    else
...
time_pill:connect_signal("button::press", 
